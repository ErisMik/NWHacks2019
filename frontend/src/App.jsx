...
const testData = {
   'transcript':[
      ...
      {
         'speaker':'harry',
         'line':' While we are at it, can you create another jira ticket for the websocket issue\n',
      ...
      {
         'speaker':'wesley',
         'line':" our backend is spitting out chinese characters, I'll create the jira for it.\n",
...
class App extends React.Component {
  ...
  */
  handleLines = (data) => {
    const result = JSON.parse(data)
    return result.transcript.map((element, index) => {
